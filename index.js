...
mongoose.connect(`mongodb+srv://jamesemery:SchoolHub@cluster0.9ku2n.mongodb.net/jpnotesdb?retryWrites=true&w=majority`, {useFindAndModify: false,useUnifiedTopology: true, useNewUrlParser: true, useCreateIndex: true, useNewUrlParser: true })
.then(
